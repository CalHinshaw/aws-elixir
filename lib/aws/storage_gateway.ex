...
defmodule AWS.StorageGateway do
  ...
  Endpoints](http://docs.aws.amazon.com/general/latest/general/latest/gr/rande.html#sg_region):
  ...
  virtual tape and then archive the tape. This operation is only supported in
